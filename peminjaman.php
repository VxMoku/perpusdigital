...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-mb-12">
                <a href="?page=peminjaman_tambah" target="_blank" class="btn btn-secondary mb-3">+</a>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                 ...
                 ?>
                    ...
                    <!-- Tombol untuk mengedit data -->
                            <a href="?page=peminjaman_ubah&&id=<?php echo $data['peminjaman_id']; ?>" class="btn btn-warning"><i class="fa fa-pen-to-square"></i></a>
                    </form>
                    <?php
                    }
                        ?>
